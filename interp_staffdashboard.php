...
{   $table_id = "interpretation_job_id";
    ...
    $query = "SELECT * FROM `interpretation_job_table` order by `".$order_parameters .
...
}else if(!empty($keywordsearch))
{
  ...
  if($_POST['filter']=="date of submission" || $_POST['filter']=="date_of_interpretation" || $_POST['filter']=="time_of_interpretation")
  {
    if($_POST['filter']=="date of submission" || $_POST['filter']=="date_of_interpretation")
    {
      ...
      WHERE `".$_POST['filter']."` LIKE '%".$newformat."%' ORDER BY `interpretation_job_id` "
  ...
  $query = "SELECT * FROM `interpretation_job_table`
  WHERE `".$_POST['filter']."` LIKE '%".$searchquery."%' ORDER BY `interpretation_job_id` "
  .pagination($table_id,$table,$page_rows,$pn);}
...
}elseif (!empty($pn))
{
  ...
  $query = "SELECT * FROM `interpretation_job_table` ORDER BY `interpretation_job_id` desc $limit";
...
<header>
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container">
      ...
      <li class="active"><a href="interp_staffdashboard.php">Manage Jobs</a></li>
...
<div id="wrapper">
        ...
        <div id="sidebar-wrapper" style="width:250px;" >
           ...
           <ul> <li>
                    <a href="interp_staffdashboard.php">
            ...
            <div class="panel-heading">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <span class="input-group-btn">
                        <form action="interp_staffdashboard.php" method="post" class="navbar-form" role="search">
                  ...
                  <div class="pcw-wrap">
                      <table class="table table-hover tr-header">
                        ...
                        <tr class="">
                          ...
                          <th>
                            <?php if($sort_parameters == 'desc' || $sort_parameters == ''){?>
                              <a class="firstname-order" href="?order=address&sort=asc">Location Address</a>
                            <?php }else{?>
                              <a class="firstname-order" href="?order=address&sort=desc">Location Address</a>
                            <?php }?>
                          </th> 
                          <th>
                            <?php if($sort_parameters == 'desc' || $sort_parameters == ''){?>
                          ...
                          <!--<th>
                            <?php if($sort_parameters == 'desc' || $sort_parameters == ''){?>
                              <a class="firstname-order" href="?order=Grant_name&sort=asc">Grant Name</a>
                            <?php }else{?>
                              <a class="firstname-order" href="?order=Grant_name&sort=desc">Grant Name</a>
                            <?php }?>
                          </th>-->
                          <th>
                            <?php if($sort_parameters == 'desc' || $sort_parameters == ''){?>
                          ...
                          <th>
                            <?php if($sort_parameters == 'desc' || $sort_parameters == ''){?>
                              <a class="firstname-order" href="?order=lang_from&sort=asc">Language</a>
                            <?php }else{?>
                              <a class="firstname-order" href="?order=lang_from&sort=desc">Language</a>
                            <?php }?>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>                    
                            <?php echo "<a href=\"InterpretationJobOverviewStaff.php?id=".$value['interpretation_job_id']."&id_update=".$value['interpretation_job_id']."\"
