  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <label class="navbar-brand" > <?php echo "Welcome, ".$_SESSION['first_name']." ".$_SESSION['last_name'];?></label>
      </div><!-- navbar-header -->
      <div class="collapse navbar-collapse" id="collapse">
        <ul class="nav navbar-nav navbar-right">
        ...
        <div id="page-content-wrapper" style="padding-left:130px;">
         ...
         <div class="container-fluid">
           <div class="form-group">
             <p> Below you can view the information of the current job. </p>
<br />
                               <div class="form-group">
                               ...
                               <button type="button" class="btn btn-primary" onclick="window.location.href = 'interp_staffdashboard.php'">Back</button>
