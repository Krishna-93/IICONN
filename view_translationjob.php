...
{   $table_id = "translation_job_id";
    ...
    $query = "SELECT * FROM `translation_job_table` WHERE `job_status` = 'Unassigned' order by `".$order_parameters .
...
}else if(!empty($keywordsearch))
{
  ...
  if($_POST['filter']=="due_date" || $_POST['filter']=="date_of_submission")
  {
    ...
    ORDER BY `translation_job_id` "
    .pagination($table_id,$table,$page_rows,$pn);
  }else{
  $query = "SELECT * FROM `translation_job_table`
  WHERE `".$_POST['filter']."` LIKE '%".$searchquery."%'
  AND `job_status` = 'Unassigned' ORDER BY `translation_job_id` "
  .pagination($table_id,$table,$page_rows,$pn);}
...
<head>
  ...
  <title>IICONN - Translation Table</title>
<style type="text/css">
    #side-bar {
      width:100%;
      float: left;
                   ...
                   <div class="container-fluid">
                       ...
                       <div class="row">
                         <div class="col-md-6">
                           ...
                           <div class="input-group">
                             <span class="input-group-btn">
                               <form action="view_translationjob.php" method="post" class="navbar-form" role="search">
                             ...
                             <tbody>
                               ...
                               <tr>
                                 ...
                                 <td>
                                   ...
                                   <?php echo "<a href=\"view_translationjoboverview.php?id=".$value['translation_Job_id']."&id_update=".$value['translation_Job_id']."\"
