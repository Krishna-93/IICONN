...
<div id="wrapper">
        ...
        <!-- Sidebar -->
        <div id="sidebar-wrapper" style="width:230px;" >
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <span class="input-group-btn">
                        <form action="admindashboard.php" method="post" class="navbar-form" role="search">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <?php echo "<a href=\"TranslationJobOverview.php?id=".$value['translation_Job_id']."&id_update=".$value['translation_Job_id']."\"
