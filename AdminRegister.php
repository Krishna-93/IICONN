...
$query =   "INSERT INTO `employee_table`(`first_name`, `last_name`,
    ...
    `zip_code`, `account_type`, `active` )
     ...
     VALUES ('".mysqli_real_escape_string($connection,trim($_POST['firstname']))."', '".
                ...
                if($result){
                  ...
                  // $lastname = ($_POST['lastname']);
                  // $email = ($_POST['email']);
                  // send_mail("Brian","Sutton" ,"Basgolfer@gmail.com" , $password);
                  send_mail_newadminaccount($firstname, $lastname, $email,$password);
                  echo "
  ...
  try {
   ...
   ->setSubject('Administrator account successfully created  ')
...
<head>
  ...
  <title>IICONN - New Admin Registration</title>
...
<div id="wrapper">
                      ...
                      <div class="panel panel-default" >
                        <div class="panel-heading"> <div class="centerDiv">
                                       ...
                                       <select name="centerSelect" onchange="location = this.options[this.selectedIndex].value;">
                                         <option>Admin</option>
                                           <option value="StaffRegister.php">Staff</option>
                                       </select>
                                   </div>
                                   </div>
  ...
  <div class="panel-heading">
    <h3 class="panel-title-primary">Admin Registration</h3>
  </div>
  ...
  <div class="container-fluid">
    ...
    <div class="form-group">
      ...
      <select class="form-control" required name="state">
        ...
        <option value="WV">West Virginia</option>1
