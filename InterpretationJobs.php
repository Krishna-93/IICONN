...
function getJobs($searchLike, $searchColumn, $limit, $offset) {
   ...
   $query = "SELECT `Title`,`Last Name`,`Submission Date`,`Lang From`,`Lang To` FROM `vInterpretationJobs` ";
    $countQuery = "SELECT COUNT(`Title`) AS `Total` FROM `vInterpretationJobs` ";
