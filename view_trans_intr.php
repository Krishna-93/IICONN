...
<head>
  ...
  <title>IICONN - Translator/Interpreter Profile Overview</title>
  </head>
...
<body>
                    ...
                    <div class="col-xs-12 col-md-8">
                      <div class="panel panel-default" >
                             ...
                             <div class="panel-heading"> <div class="centerDiv">
                                      <h3 class="panel-title-primary">Profile Page for <?php echo $firstName . '&nbsp;' . $lastName ?> (Translator/Interpreter)</h3>
  ...
  <div class="container-fluid">
    ...
    <button type="button" class="btn btn-primary" onclick="window.location.href = 'manage_otheracc.php'">Ok</button>
   <button type="submit" class="btn btn-primary"  formaction="view_trans_intr.php?id=<?php echo $TranslatorInterpreterId?>" name="submit">Update existing job</button>
                              </div></form>
       </div>
                   </div>
               </div>
