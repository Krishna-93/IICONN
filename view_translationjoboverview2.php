...
$query = "SELECT `job_title`, `job_status`, `translator_interpreter_id`, `first_name`, `last_name`, `email_address`,
 ...
 if(isset($_POST['submit']))
 {
   ...
   $name1 = $_FILES['translatedDocuments']['name'];
   $filepath = '/var/www/html/uploads/Other/';
   $filepathTranslatedDocuments ='/var/www/html/uploads/translationjobdocs/';
   $sourceTranslatedDocuments = "http://iiconn.club/uploads/translationjobdocs/";
   $source = "http://iiconn.club/uploads/Other/";
   $Invoice =   addslashes($source . $unique . $name);
   $completedDocuments = addslashes($sourceTranslatedDocuments . $unique . $name1);
   $updateQuery = "UPDATE `translation_job_table`
   SET `Invoice` = '$Invoice', 	`job_doc_after_translation/interpretation` = '$completedDocuments',
   `job_status` = 'Completed'
   WHERE `translation_Job_id` = $job_id ";

   if (uploadOther('invoice', $filepath, $unique) === true)
{
        if (uploadCompletedTranslationJob('translatedDocuments', $filepathTranslatedDocuments, $unique) === true)
        {
          $result2 = mysqli_query($connection, $updateQuery);
          if ($result2) {
            echo " <script type=\"text/javascript\">
            alert('Invoice and documents uploaded successfully.');
...
<div id="wrapper">
 ...
 <div id="sidebar-wrapper" style="width:250px;" >
        ...
        <div id="page-content-wrapper" style="padding-left:130px;">
         ...
         <div class="panel-body">
           <p></p>
                            ...
                            <form method="post" action="view_translationjoboverview2.php" accept-charset='UTF-8' enctype="multipart/form-data" >
         <div class="container-fluid">
           <div class="form-group">
             <p> Below you can view the information of the current job. You can upload the completed job documents and your invoice on this page. </p>
             <p> An <span class="required">* </span> indicates that the field is required.
                               <br />
                               <div class="form-group">
                          ...
                          <select required name="Job_Title" class="form-control" disabled>
  ...
  <div class="form-group">
                            ...
                            <div class="form-group">
                                                 <label for="ft_autho">Upload translated documents: <span class="required">* </span> <br></label>
                                                   <input type="file" class="form-control" name="translatedDocuments" required>
                                                 </div>
                               ...
                               <button type="submit" class="btn btn-primary"  formaction="view_translationjoboverview2.php?id=<?php echo $job_id?>" name="submit">Upload invoice and documents</button>
