 ...
 <div id="page-content-wrapper" style="padding-left:130px;">
  ...
  <div class="panel-body">
    <p></p>
                     ...
                     <form method="post" action="CreateNewTranslationJobStaff.php" accept-charset='UTF-8' enctype="multipart/form-data" >
  <div class="container-fluid">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                     <label for="ft_author">Special Instructions:</label>
                      ...
                      <button type="reset" class="btn btn-primary" onclick="window.location.href = 'CreateNewTranslationJobStaff.php'">Reset</button>
