            ...
            <div class="panel-heading">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="input-group">
                      <span class="input-group-btn">
                          <select name="page_switch" id="page_switch" class="form-control">
                               <option value="interp_admindashboard.php">Interpretation Table</option>
                              <option value="admindashboard.php">Translation Table</option>
                          </select>
                      </span>
                    </div><!-- /input-group -->
                  </div>
                    ...
                    <div class="input-group">
                      <span class="input-group-btn">
                        <form action="interp_admindashboard.php" method="post" class="navbar-form" role="search">
                  ...
                  <div class="pcw-wrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo "<a href=\"InterpretationJobOverview.php?id=".$value['interpretation_job_id']."&id_update=".$value['interpretation_job_id']."\"
