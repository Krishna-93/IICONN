...
`Grant_name`, `lang_to`, `special_instructions`, `invoice`  From `interpretation_job_table` Where `interpretation_job_id` = $job_id ";
 ...
 <?php
  ...
  try {
   ...
   ->setSubject('Successfully updated Interpretation job.')
        ...
        <div id="page-content-wrapper" style="padding-left:130px;">
         ...
         <div class="panel-body">
           <p></p>
                            ...
                            <form method="post" action="InterpretationJobOverview.php" accept-charset='UTF-8' enctype="multipart/form-data" >
         <div class="container-fluid">
             ...
             in new values and clicking update. </p>
                               ...
                               <div class="form-group">
                                 ...
                                 <input value="<?php echo $job_id; ?>" type="text" class="form-control" placeholder="Job ID" Name="Job_ID" maxlength="50" disabled >
                                  ...
                                  <div class="form-group">
                                        <label for="ft_author">Job Status: <span class="required">*</span><br></label>
                                        <select class= "form-control" name="Job_Status" required aria-required="true">
                                  ...
                                  <input value="<?php echo $lastName; ?>" type="text" class="form-control" placeholder="Last Name" Name="ClientsLastName" maxlength="50" pattern="[a-zA-Z\s]+" title="No Numbers" required>
                                   ...
                                   <input value="<?php echo $dateOfInterpretation; ?>" type="date" class="form-control" name='dateOfInterpretation' id="dueDate"  required>
                                   </div>
                                   <div class="form-group">
                                   <label for="Gender">Time of Interpretation: <span class="required">*</span></label>
                                   <input value="<?php echo $timeOfInterpretation; ?>" type="time" class="form-control" name='timeOfInterpretation' id="dueDate"  required>
                                   </div>
                                   <div class="form-group">
                                   <label for="Gender">Estimated length of Interpretation: (in minutes) <span class="required">*</span></label>
                                   <input value="<?php echo $lengthOfInterpretation; ?>" type="number" class="form-control" name='lengthOfInterpretation' id="dueDate" min="15" max="300" value="15" step="15" required>
                                   </div>
                                    <div class="form-group">
                               ...
                               <button type="button" class="btn btn-primary" onclick="window.location.href = 'interp_admindashboard.php'">Ok</button>
                               <button type="submit" class="btn btn-primary"  formaction="InterpretationJobOverview.php?id=<?php echo $job_id?>" name="submit">Update existing job</button>
