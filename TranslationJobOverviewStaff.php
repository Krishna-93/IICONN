                           ...
                           <select required name="Job_Title" class="form-control" disabled>
                                  ...
                                  <div class="form-group">
                                        <label for="ft_author">Job Status:<br></label>
                                         <select required aria-required="true" id="State" name="Job_Status" class="form-control" disabled>
                                  ...
                                  <input value="<?php echo $lastName; ?>" type="text" class="form-control" placeholder="Last Name" Name="ClientsLastName" maxlength="50" pattern="[a-zA-Z\s]+" title="No Numbers" required disabled>
       							...
       							<div class="form-group">
       							<label for="ft_author">Address: <br></label>
                               ...
                               <button type="button" class="btn btn-primary" onclick="window.location.href = 'staffdashboard.php'">Back</button>
                               </div></form>
       </div>
                   </div>
               </div>
