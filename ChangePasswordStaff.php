 ...
 $query = "SELECT `password` FROM `employee_table` WHERE `employee_id` = $employee_id ";
...
if ($password === $PasswordUserTypedInOnPage)
{
  ...
  alert('Correct current password.'); </script>";
        ...
        {
          $NewPasswordQuery = "UPDATE `employee_table`
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="collapse">
       ...
       <li><a href="staffdashboard.php">Manage Jobs</a></li>
        <li class="active"><a href="Staffinfo.php">Manage Accounts</a></li>
...
<div id="wrapper">
        ...
        <div id="sidebar-wrapper" style="width:250px;" >
            ...
            <ul class="sidebar-nav" >
             ...
             <ul>
                                <li><a href="Staffinfo.php">Manage Your Account</a></li>
