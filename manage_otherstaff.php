...
{   $table_id = "employee_id";
    ...
    $query = "SELECT * FROM `employee_table`WHERE  `account_type` LIKE  'Staff' order by `".$order_parameters .
...
}else if(!empty($keywordsearch))
{
  ...
  $page_rows = 5;
  $last = numb_pages($table_id,$table,$page_rows);
  $query = "SELECT * FROM `employee_table`WHERE `account_type` LIKE  'Staff' AND `".$_POST['filter']."` LIKE '%".$searchquery."%' ORDER BY `employee_id` "
...
elseif (!empty($pn))
{
  $row_count = "Select COUNT(`employee_id`) FROM `employee_table`";
  ...
  $query = "SELECT * FROM `employee_table`WHERE  `account_type` LIKE  'Staff' ORDER BY `employee_id` desc $limit";
  ...
  $page_rows = 5;
  $last = numb_pages ($table_id,$table,$page_rows);
  $query = "SELECT * FROM `employee_table`WHERE  `account_type` LIKE  'Staff'
  ORDER BY `employee_id` desc ".pagination($table_id,$table,$page_rows,$pn);
...
<head>
  ...
  <title>IICONN - Manage other account staff</title>
</head>
<body>
<header>
  <div class="bigimage">
                    ...
                    <a href="#">
                        Admin Dashboard
                            ...
                            <ul> <li><a href="AdminInfo.php">Manage Your Account</a></li>
                                <li><a href="manage_otherstaff.php"> Manage Other Accounts</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <span class="input-group-btn">
                        <form action="manage_otherstaff.php" method="post" class="navbar-form" role="search">
                  ...
                  <div class="pcw-wrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo "<a href=\"view_staff.php?id=".$value['employee_id']."&id_update=".$value['employee_id']."\"
